...
class TANet(nn.Module):
    ...
    def __init__(self, encoder_arch, local_kernel_size, stride, padding, groups, drtam, refinement, pretrain,sslpretrain, ssl_path):
        super(TANet, self).__init__()

        self.encoder1, channels = get_encoder(encoder_arch,ssl_path, pretrained=pretrain, sslpretrain= False)
        self.encoder2, _ = get_encoder(encoder_arch,ssl_path,  pretrained=pretrain, sslpretrain= False)
